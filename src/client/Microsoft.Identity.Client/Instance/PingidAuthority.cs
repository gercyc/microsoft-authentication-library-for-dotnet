...
namespace Microsoft.Identity.Client.Instance
{
    internal class PingidAuthority : Authority
    {
        ...
        private const string AuthorizationEndpointTemplate = "{0}as/authorize";
        ...
        internal PingidAuthority(AuthorityInfo authorityInfo) : base(authorityInfo)
        {
